...
<tr>
<td>
NAME :</td><td>   <input type="text" name="name" value="<?php echo $name;?>"></td><td> <span id="error">*
<?php echo $noname; ?></span></td></tr> 
<tr><td>
EMAIL:</td><td>   <input type="text" name="email" value="<?php echo $email;?>"></td><td> <span id="error">*
<?php echo $noemail; ?></span></td> </tr>
<tr><td>
JOB  : </td><td>    <input type="text" name="job" value="<?php echo $job;?>"></td><td> <span id="error">*
<?php echo $nojob; ?></span></td> </tr>
</tr><td>
SALARY:</td><td>   <input type="text" name="salary" value="<?php echo $salary;?>"></td><td> <span id="error">*
<?php echo $nosalary ; ?></td></span>
<tr><td>
GENDER:</td><td>   <input type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">MALE
		<input type="radio" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">FEMALE</td><td> <span id="error">*
...
<!-- -- --<button name="edit" onclick='window.location.replace("http://localhost/stgobain/edit_dataright.php")' id="button">EDIT</button>-->
<button name="view" id="button" onclick= 'window.location.replace("http://localhost/stgobain/display_data.php")'w3>VIEW</button>
</center>
</div>
</body>
</html>
