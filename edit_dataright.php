...
NAME : <br><br> <input type="text" name="name" value="<?php echo $name;?>"><span id="error">*
<?php echo $noname; ?></span> <br><br>
EMAIL:<br><br> <input type="text" name="email" value="<?php echo $email;?>"><span id="error">*
<?php echo $noemail; ?></span> <br><br>
JOB  :  <br><br> <input type="text" name="job" value="<?php echo $job;?>"><span id="error">*
<?php echo $nojob; ?></span> <br><br>
SALARY:<br><br> <input type="text" name="salary" value="<?php echo $salary;?>"><span id="error">*
...
GENDER:<br><br> <input type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">MALE
		<input type="radio" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">FEMALE*<span>
<?php echo $nogender; ?></span><br>
<input type="submit" name="submit" value="UPDATE" id="submit">
</form>
</div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<div>
<button name="back" id="button" onclick= 'window.location.replace("http://localhost/stgobain/employee.php")'>BACK</button>
</div>
</center>
</body>
</html>
